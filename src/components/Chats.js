				...
				<div className=" chats__wrapper container">
					<List className="chats__list">
						{Object.values(chats).map((chat) => {
							return <li className="chats__item chats-item">
								<ListItem
								...
								<button class="chats-item__button" onClick={() => handleRemoveChat(chat.id)} type="button"><svg width="13" height="13" viewBox="0 0 13 13"
